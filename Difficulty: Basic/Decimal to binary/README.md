<h2><a href="https://www.geeksforgeeks.org/problems/decimal-to-binary-1587115620/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Decimal to binary</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a decimal number <strong>n</strong>, return its binary equivalent.</span></p>
